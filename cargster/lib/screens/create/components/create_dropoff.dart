...
class CreateDropoff extends StatefulWidget {
  ...
  CreateDropoff(this.defaultValue);

  @override
  _CreateDropoffState createState() => _CreateDropoffState();
}
      ...
      children: [
        ...
        TextFormField(
          ...
          onChanged: (value) {
            ...
            currentPost.dropOff.companyName = value;
            providerContainer.read(currentShipperPostProvider).state =
                currentPost;
            return null;
          },
        ...
        TextFormField(
          ...
          onChanged: (value) {
            CargsterShipperPostEntity currentPost =
                providerContainer.read(currentShipperPostProvider).state;
            currentPost.dropOff.address = value;
            providerContainer.read(currentShipperPostProvider).state =
                currentPost;
            return null;
          },
        ...
        InkWell(
            ...
            onTap: () {
              return Alert(
                  ...
                  content: Column(
                    children: [
                      CreateCustoms(widget.defaultValue, type: 'dropOff')
                    ],
                  ),
                  buttons: []).show();
            }),
